...
export const me = createAsyncThunk("auth/me", async () => {
  ...
  if (token) {
    const res = await axios.get("https://API_URL.herokuapp.com/", {
      headers: {
...
export const register = createAsyncThunk(
  ...
  async (formInfo, { dispatch, rejectWithValue }) => {
    try {
      ...
      const res = await axios.post(`https://API_URL.herokuapp.com/user/register`, {
        first_name,
        last_name,
        birthday,
        email,
...
export const authenticate = createAsyncThunk(
  ...
  async (formInfo, { dispatch, rejectWithValue }) => {
    try {
      ...
      const res = await axios.post(`https://API_URL.herokuapp.com/user/login`, {
        email,
        password,
      });
  ...
  async (formInfo, { dispatch, rejectWithValue }) => {
    ...
    try {
      if (token) {
        ...
        const res = await axios.post(`https://API_URL.herokuapp.com/user/${user_id}`, {
          first_name,
          last_name,
          email,
          street_address,
  ...
  async (formInfo, { dispatch, rejectWithValue }) => {
    ...
    try {
      if (token) {
        ...
        const res = await axios.get(`https://API_URL.herokuapp.com/user/trades/${user_id}`,{
          headers: {
            Authorization: "Bearer " + token,
          }
        });
  ...
  async (formInfo, { dispatch, rejectWithValue }) => {
    ...
    try {
      if (token) {
        ...
        const res = await axios.get(`https://API_URL.herokuapp.com/user/pnlbyYear/${user_id}/${year}`,{
          headers: {
            Authorization: "Bearer " + token,
          }
        });
...
export const deleteUser = createAsyncThunk(
  ...
  async (formInfo, { dispatch, rejectWithValue }) => {
    ...
    try {
      if (token) {
        const { user_id } = formInfo;
        const res = await axios.delete(`https://API_URL.herokuapp.com/user/${user_id}`,{
          headers: {
            Authorization: "Bearer " + token,
          }
        });
  ...
  async (formInfo, { dispatch, rejectWithValue }) => {
    ...
    try {
      if (token) {
        ...
        const res = await axios.post(`https://API_URL.herokuapp.com/user/changePassword/${user_id}`,{
          curr_pass,
          new_pass_1,
          new_pass_2
        },{
  ...
  async (formInfo, { dispatch, rejectWithValue }) => {
    ...
    try {
      if (token) {
        ...
        const res = await axios.post(`https://API_URL.herokuapp.com/user/reportBug`,{
          summary,
          description,
          page
        },{
